      ...
      <div className="relative w-full h-150 lg:h-150 bg-[url('/src/assets/images/banner_home.png')] bg-no-repeat bg-cover bg-right max-h-[800px]">
              <div className="absolute inset-0 flex flex-col pb-10 justify-end sm:justify-center items-start px-10 ">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white drop-shadow-lg">
                  TI profissional <br /><span className="text-[#2a8ecc]"> no seu bolso</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-10 z-10">
                  <Button size="lg" variant="outline" className="gap-2 text-base text-white hover:text-white bg-[#2a8ecc] hover:bg-[#0D2B3E]" asChild>
                      <a href="#planos" >
                          Ver Planos
